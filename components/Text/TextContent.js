...
const TextContent = ({ blok }) => {
  ...
  return (
    <div {...storyblokEditable(blok)} className="relative w-full grid grid-cols-12 font-montserrat ">
      {blok.headline && (
      ...
      {blok.paragraph && (
        <div className="col-start-4 col-end-12 md:col-start-6 lg:col-end-12 2xl:col-start-7 2xl:col-end-12 text-left">
          <p className="md:text-xl lg:text-2xl 2xl:text-3xl font-light whitespace-pre-wrap">{blok.paragraph}</p>
        </div>
      )}
    </div>
  );
