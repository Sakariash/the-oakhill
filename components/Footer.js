    ...
    <div className="col-span-2 md:col-span-2 mt-8 md:mt-0 flex flex-wrap justify-between">
      <ul role="list" className="w-1/2 space-y-4">
        <li><a href="#" className="text-sm md:text-lg relative group hover:text-gray-900">Projekt
           ...
           <li><a href="/about" className="text-sm md:text-lg relative group hover:text-gray-900 ">Om oss<span className="absolute -bottom-1 left-0 w-0 h-[1px] bg-gray-400 transition-all duration-700 ease-in-out group-hover:w-full"></span></a></li>
