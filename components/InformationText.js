...
const InformationText = ({ blok }) => {
  ...
  return (
    ...
    <div ref={ref} {...storyblokEditable(blok)} className="mt-28 py-9 relative w-full grid grid-cols-12 grid-rows-10 bg-oakhill-black font-montserrat text-white overflow-hidden">
      {blok.headline && (
