  ...
  return (
    <div {...storyblokEditable(blok)} className="relative max-w-4xl mx-auto font-montserrat text-left p-6 shadow-md rounded-lg border border-oakhill-green">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        {blok.name && (
          <div className="mb-4">
            <label htmlFor="name" className="block text-gray-700 font-medium mb-1 px-2">
              Namn
            </label>
            <input
              type="text"
        ...
        {blok.lastname !== undefined && (
          <div className="mb-4">
            <label htmlFor="lastname" className="block text-gray-700 font-medium mb-1 px-2">
              Efternamn
            </label>
            <input
              type="text"
        ...
        {blok.address !== undefined && (
          <div className="mb-4">
            <label htmlFor="address" className="block text-gray-700 font-medium mb-1 px-2">
              Adress
            </label>
            <input
              type="text"
        ...
        {blok.description !== undefined && (
          <div className="mb-4">
            <label htmlFor="description" className="block text-gray-700 font-medium mb-1 px-2">
              Beskrivning
            </label>
            <textarea
              id="description"
